...
const eventDefinitions = [
    ...
    { name: '創作料理', count: 2, description: '手札かセットから2枚で3点。今ターン他の料理不可' },
    { name: '爆買い', count: 2, description: '山札から3枚引く' },
    { name: '食材探索', count: 2, description: '上3枚を見て最大2枚得る' },
    { name: '大掃除', count: 2, description: '相手の手札とセットカードをすべて捨てさせる' },
    { name: '緊急調理', count: 2, description: '5点以下で手札かセット1枚+イベントで3点' }
];

const packDefinitions = [
    { key: 'knife', name: '包丁', cost: 3, description: '料理時に材料1枚を2枚扱い' },
    { key: 'freezer', name: '冷凍庫', cost: 3, description: 'セット上限が3枚になる' },
    { key: 'board', name: 'まな板', cost: 3, description: 'ドロー時に手札6枚まで補充' }
];
